...
export const getAlbumsThunks = createAsyncThunk<AlbumResponse, string>(
  "albums/getAlbumsThunks",
  async (id: string) => {
...
export const deleteAlbumThunks = createAsyncThunk<
  void,
  string,
  { rejectValue: GlobalError }
>("albums/deleteAlbumThunks", async (id: string, { rejectWithValue }) => {
  try {
