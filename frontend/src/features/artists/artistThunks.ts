...
export const getArtistThunks = createAsyncThunk<Artist[], void>(
  "artists/getArtistThunks",
  async () => {
...
export const deleteArtistThunks = createAsyncThunk<
  void,
  string,
  { rejectValue: GlobalError }
>("artists/deleteArtistThunks", async (id: string, { rejectWithValue }) => {
  try {
