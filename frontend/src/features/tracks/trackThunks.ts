...
import {GlobalError, TrackMutation, TrackResponse, ValidationError} from "../../types";
...
export const createTrackThunks = createAsyncThunk<void, TrackMutation, { rejectValue: ValidationError }>(
    'tracks/createTrackThunks',
...
export const deleteTrackThunks = createAsyncThunk<void,string,{rejectValue: GlobalError}>(
    "tracks/deleteTrackThunks",
